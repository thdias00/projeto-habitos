import { AppBar, Box, Toolbar, Typography, Menu, Container, Avatar, Button, Tooltip, MenuItem, IconButton, ThemeProvider } from '@mui/material';
...
const ResponsiveAppBar = () => {
    ...
    const { logout, updateUser, user, mobileVersion } = useAuth();
    ...
    return (
        <ThemeProvider theme={theme}>
            <AppBar position="static" color={mobileVersion ? "primaryLight" : "primary"} >
